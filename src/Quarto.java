...
public class Quarto {
    ...
    static String quartosMAX[] = new String[Hotel.hotelQuartos];
    static double[] tamanho = new double[Hotel.hotelQuartos];
    String[] quartoCamas = new String[Hotel.hotelQuartos],quartoTipo = new String[Hotel.hotelQuartos];
    public void menu() {
        Object[] options = {"Cadastrar Quarto", "Buscar Quarto", "Editar Quarto", "Voltar"};
        int menuQuarto = JOptionPane.showOptionDialog(null, "", "", 0, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        while (menuQuarto != 4) {
            switch (menuQuarto) {
                case 0:
                    cadastrarQuarto();
            ...
            menuQuarto = JOptionPane.showOptionDialog(null, "", "", 0, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        }
    }
